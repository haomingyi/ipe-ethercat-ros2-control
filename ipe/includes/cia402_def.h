...
{
    int8_t ObjModesOfOperationDisplay; /**< \brief Current mode of operation (0x6061)*/
    uint8_t Padding8Bit; /**< \brief 8bit padding*/
    uint16_t ObjStatusWord; /**< \brief Status word (0x6041)*/
    int32_t ObjPositionDemandValue; /**< \brief demand position (0x6062)*/
    int32_t ObjPositionActualValue; /**< \brief Actual position (0x6064)*/
    int32_t ObjVelocityDemandValue; /**< \brief demand velocity (0x606B)*/
    int32_t ObjVelocityActualValue; /**< \brief Actual position (0x606C)*/
    int16_t ObjTorqueDemandValue; /**< \brief demand torque (0x6074)*/
    int16_t ObjTorqueActualValue; /**< \brief Actual velocity (0x6077)*/
    uint32_t DigitalInputs; /**< \brief Digital Inputs*/
    uint32_t ErrorCode; /**< \brief Error code (0x603F)*/
}STRUCT_PACKED_END
TCiA402PDO1A00;

/** \brief Data structure to handle the process data transmitted via 0x1600 (csp RxPDO)*/
typedef struct STRUCT_PACKED_START
{
    int8_t ObjModesOfOperation; /**< \brief Current mode of operation setting (0x6060)*/
    uint8_t Padding8Bit; /**< \brief 8bit padding*/
    ...
    int16_t ObjTargetTorque; /**< \brief Target velocity (0x6071)*/
    uint16_t Padding16Bit; /**< \brief 16bit padding*/
    uint32_t DigitalOutputs; /**< \brief Digital Outputs*/
}STRUCT_PACKED_END
TCiA402PDO1600;
/** @}*/
